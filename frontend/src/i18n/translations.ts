...
export const translations = {
  it: {
    ...
    demoFallbackBadge: "Demo fallback",
    connectingLabel: "Connessione…",
    startAnalysis: "Avvia nuova analisi tattica",
    startAnalysisDesc: "Configura lo scenario, poi registra i punti in tempo reale con le previsioni AI aggiornate ad ogni punto.",
    jumpPreset: "oppure salta a un preset",
    confirmStart: "Conferma e Avvia Live",
    pointHistory: "Storico punti",
    outputMode: "Modalità output",
    fanInsight: "Fan Insight",
    coachInsight: "Coach Insight",
    mediaInsight: "Media Insight",
    completeWorkflow: "Completa il flusso per generare gli insight",
    nextPointProb: "Probabilità vittoria prossimo punto",
    pointsPlayed: "punti giocati",
    matchWins: "vince il match",
    aiPredOffline: "Predizione AI Offline",
    aiPredOfflineDesc: "La predizione tattica real-time richiede una connessione attiva col backend.",
    localEngineActive: "Scoring Engine Locale Attivo",
    localEngineDesc: "Punteggio, statistiche ed export CSV/JSON continuano a funzionare offline.",
    enableDemo: "Attiva Demo",
    disableDemo: "Disattiva simulazione",
  ...
  en: {
    ...
    startAnalysis: "Start a new tactical analysis",
    startAnalysisDesc: "Set up the match scenario, then tag points in real-time with AI predictions updating after every point.",
    jumpPreset: "or jump to a preset",
    confirmStart: "Confirm & Start Live",
    pointHistory: "Point history",
    outputMode: "Output mode",
    fanInsight: "Fan Insight",
    coachInsight: "Coach Insight",
    mediaInsight: "Media Insight",
    completeWorkflow: "Complete the workflow to generate insights",
    nextPointProb: "Next-point win probability",
    pointsPlayed: "points played",
    matchWins: "wins the match",
    aiPredOffline: "AI Prediction Offline",
    aiPredOfflineDesc: "Real-time tactical prediction requires an active backend connection.",
    localEngineActive: "Local Scoring Engine Active",
    localEngineDesc: "Score tracking, statistics and CSV/JSON export continue to work offline.",
    enableDemo: "Enable Demo",
    disableDemo: "Disable simulation",
